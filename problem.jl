...
x_points = [1; 1.5; 3; 3.1; 3.2; 3.301; 3.401; 3.5; 4; 4.1; 3.9; 0; 0.5; 1]
y_points = [0; 0.5; 0; -0.2; -0.3; -0.3501; -0.301; -0.2; 0; 2; 2.5; 2.5; 0.5; 0.25]
...
function create_U0(track_bound, width)
...
function objective_function(x0)
    U = transpose
